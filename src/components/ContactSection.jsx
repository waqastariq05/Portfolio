...
const ContactSection = ({ setAlert, setAlertData }) => {
  ...
  return (
    <div
      id="contact"
      className="w-full md:w-[90%] mx-auto pt-10 mb-16 sm:mb-28 px-5 md:px-0 section"
    >
      <SubTitleSection
        title="Contact"
        text="Let’s talk for your next projects"
      />
      <div className="sm:px-10 flex md:flex-nowrap flex-wrap">
        <div className="w-full lg:w-1/3 md:w-1/2 sm:mr-10 mt-2 sm:mt-7">
          <div className="flex items-start justify-start gap-4 mb-8">
            ...
            <div>
              <p className="text-sm sm:text-base text-white tracking-wide">
                Flat No E-17, Sana Avenu, Block 12, Gulistan-e-johar, Karachi
                Pakistan
              </p>
            </div>
          </div>
          ...
          <form ref={form} onSubmit={handleSubmit}>
            <div className="flex flex-wrap sm:flex-nowrap items-center gap-4 sm:gap-5 mb-4 sm:mb-5">
              <div className="w-full">
                <label
                  htmlFor="name"
                  className="leading-10 text-sm text-white/90"
                >
                  Full Name
                </label>
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full bg-transparent border-2 border-white/80 rounded-lg focus:border-textOrange text-base outline-none py-2 px-3 text-white placeholder:text-sm"
            ...
            <button
              className="btn w-[60%] sm:w-auto m-0 mx-auto sm:m-[10px] flex items-center justify-center gap-2"
