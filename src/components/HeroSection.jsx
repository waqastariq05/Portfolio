...
const HeroSection = () => {
    ...
    useEffect(() => {
        const typed = new Typed(el.current, {
            strings: ["Full Stack Developer.", "UI/UX Developer."],
            typeSpeed: 50,
            backSpeed: 30,
            loop: true,
            showCursor: true
    ...
    return (
        <div className='w-full md:w-[85%] grid grid-flow-row md:grid-cols-2 items-center md:gap-5 mx-auto md:h-screen mb-16 md:mb-0' id='home'>
            ...
            <div className='pt-5 order-2 md:order-none px-5 md:px-0 md:pt-10'>
                ...
                <h2 className='text-white lg:text-6xl md:text-5xl text-4xl font-bold mb-5 capitalize'>i’m Waqas Tariq</h2>
            ...
            <div className='pt-5 md:pt-0 mt-10'>
                <svg id="sw-js-blob-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style={{ filter: "drop-shadow(0 0 15px rgba(253, 72, 29, 1))" }}>
                    <defs>
                        <linearGradient id="sw-gradient" x1="0" x2="1" y1="1" y2="0">
                            <stop id="stop1" stopColor="rgba(253, 72, 29, 1)" offset="20%"></stop>
                            <stop id="stop2" stopColor="rgba(240, 152, 25, 1)" offset="80%"></stop>
                        </linearGradient>
                    </defs>
                    <mask id='mask1' mask-type='alpha'>
                        <path fill="url(#sw-gradient)" d="M21,-19.5C28.1,-13.8,35.5,-6.9,35.5,-0.1C35.4,6.8,27.8,13.5,20.7,21C13.5,28.4,6.8,36.6,-1,37.6C-8.7,38.5,-17.4,32.3,-24.4,24.8C-31.5,17.4,-36.9,8.7,-36,0.9C-35.1,-6.9,-27.9,-13.8,-20.9,-19.5C-13.8,-25.2,-6.9,-29.7,0,-29.7C6.9,-29.7,13.8,-25.2,21,-19.5Z" width="100%" height="100%" transform="translate(50 50)" strokeWidth="0" style={{ transition: "all 0.3s ease 0s" }}></path>
                    </mask>
                    <g mask='url(#mask1)'>
                        <path fill="url(#sw-gradient)" d="M21,-19.5C28.1,-13.8,35.5,-6.9,35.5,-0.1C35.4,6.8,27.8,13.5,20.7,21C13.5,28.4,6.8,36.6,-1,37.6C-8.7,38.5,-17.4,32.3,-24.4,24.8C-31.5,17.4,-36.9,8.7,-36,0.9C-35.1,-6.9,-27.9,-13.8,-20.9,-19.5C-13.8,-25.2,-6.9,-29.7,0,-29.7C6.9,-29.7,13.8,-25.2,21,-19.5Z" width="100%" height="100%" transform="translate(50 50)" strokeWidth="0" style={{ transition: "all 0.3s ease 0s" }}></path>
