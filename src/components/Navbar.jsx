        ...
        <div className='bg-[#0e1630] fixed top-0 left-0 right-0 w-full px-5 py-[14px] md:py-1 flex items-center justify-between mx-auto z-10 md:px-10 lg:px-16 border-b-2 border-cardBGColor'>
            ...
            <nav className={`${!toggle ? "-translate-x-[100%]" : "-translate-x-0"} transition-all duration-300 py-5 bg-cardBGColor/50 backdrop-blur-md z-10 shadow-md absolute left-0 right-0 top-[70px] md:bg-transparent h-screen md:h-auto md:static md:py-0 md:-translate-x-0 md:shadow-none`}>
                <ul className={`flex flex-col items-center h-[80%] md:h-auto justify-center md:flex-row gap-7`}>
                    <li><a href="#home" className="text-white text-base font-bold uppercase tracking-wide hover:text-textOrange transition-all duration-300" onClick={handleToggle}>Home</a>
                    </li>
                    <li><a href="#skill" className='text-white text-base font-bold uppercase tracking-wide hover:text-textOrange transition-all duration-300' onClick={handleToggle}>Skills</a>
                    </li>
                    <li><a href="#project" className='text-white text-base font-bold uppercase tracking-wide hover:text-textOrange transition-all duration-300' onClick={handleToggle}>Projects</a>
                    </li>
                    <li><a href="#contact" className='text-white text-base font-bold uppercase tracking-wide hover:text-textOrange transition-all duration-300' onClick={handleToggle}>Contact</a>
                    </li>
